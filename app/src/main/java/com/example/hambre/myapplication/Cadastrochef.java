...
class Cadastrochef extends AppCompatActivity {

    private static final String PREF_NAME = "LoginChefPreferences";
    private EditText email1,senha1,senha2;
    private Button btncadastro;
    private RequestQueue requestQueue;
    private static final String URL = "http://tellunar.com.br/chef_cadastro.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastrochef);

        SharedPreferences sp;
        sp = getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);


        email1 = (EditText)findViewById(R.id.emailchefc);
        senha1 = (EditText)findViewById(R.id.senhacadc);
        senha2 = (EditText)findViewById(R.id.senhacadc1);
        btncadastro =(Button)findViewById(R.id.cadchef);
